...
export default function JwtDecoder() {
  ...
  return (
    <div>
      ...
      {/* Warning Banner */}
      <div className="flex items-center gap-2 px-4 py-3 bg-amber-500/10 border border-amber-500/20 text-amber-400 text-sm">
      ...
      <div className="bg-bg-surface border border-border p-4">
        ...
        <textarea
          ...
          rows={4}
          className="w-full bg-bg-elevated border border-border px-4 py-3 font-mono text-sm text-text-primary placeholder:text-text-tertiary focus:outline-none focus:border-accent resize-y break-all"
        />
        {isInvalidInput && (
      ...
      {decoded && (
        <>
          ...
          {("sub" in decoded.payload ||
            ...
            <div className="bg-bg-surface border border-border p-4 space-y-2.5">
          ...
          <div className="bg-bg-surface border border-border p-4">
            ...
            <div className="bg-bg-elevated border border-border p-4 font-mono text-xs text-text-secondary break-all leading-relaxed">
...
function JsonSection({
  ...
  return (
    <div className="bg-bg-surface border border-border p-4">
      ...
      <pre
        className="bg-bg-elevated border border-border p-4 font-mono text-sm leading-relaxed overflow-x-auto"
