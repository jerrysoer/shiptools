    ...
    <div className="space-y-6">
      ...
      {jobs.length > 0 && (
        <div className="space-y-2">
          ...
          {pendingCount > 0 && (
            <button onClick={() => { trackEvent("tool_used", { tool: "convert-documents" }); processAll(); }} className="w-full py-2.5 bg-accent hover:bg-accent-hover text-accent-fg text-sm font-medium transition-colors">
