...
export const metadata: Metadata = {
  title: "Transparency — ShipLocal",
  description:
    "See exactly what ShipLocal tracks, how it compares to typical tools, and audit our analytics source code.",
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              ...
              data. Here is everything ShipLocal tracks — and everything it
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-text-secondary mb-4">
                ShipLocal fires 10 analytics events. Each one is listed below
